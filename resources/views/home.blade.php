      ...
      <div class="md:hidden" id="mobile-menu">
        ...
        <div class="pt-4 pb-3 border-t border-gray-700">
          ...
          <div class="mt-3 px-2 space-y-1">
            ...
            <a href="{{ route('logout') }}" class="block px-3 py-2 rounded-md text-base font-medium text-gray-400 hover:text-white hover:bg-gray-700" onclick="event.preventDefault();document.getElementById('logout-form').submit();">Sign out</a>
