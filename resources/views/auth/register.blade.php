      ...
      <form class="mt-8 space-y-6" action="{{ route('register') }}" method="POST">
        ...
        <div class="rounded-md shadow-sm -space-y-px">
          ...
          <div class="col-span-6 sm:col-span-3">
            ...
            <select id="status" name="status" autocomplete="status"  required class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="status" >
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('Status Users') }}</label>

                            <div class="col-md-6">
                                <select name="status" id="status" class="col-md-4 col-form-label text-md-right">
                                    <option value="1" class="col-md-4 col-form-label text-md-right">Admin</option>
                                    <option value="2" class="col-md-4 col-form-label text-md-right">User</option>
                                </select>
